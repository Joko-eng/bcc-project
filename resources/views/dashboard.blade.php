<x-app-layout>
  <x-layout>
    ...
    <!-- <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
      ...
      <div id="data-container" data-categories='@json($categ)'></div>
...
<div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
  <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
    <div class="flex items-center">
      ...
      <div>
        <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">{{ $total }}</h5>
        <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Total Pengunjung</p>
      </div>
    </div>
    <div>
...
<div id="data-container" data-categories='@json($categories->pluck("nama_kategori"))'
    ...
    <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
      <div class="flex justify-between items-center pt-5">
        ...
        <p class="text-base font-bold text-gray-500 dark:text-gray-400">Total Keseluruhan Produk :  {{ $produkCount }}</p>
