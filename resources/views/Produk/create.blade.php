<x-app-layout>
    <x-layout>
        ...
        <h1 class="mb-4 py-2 text-xl font-bold text-gray-900 dark:text-white ">Tambah Produk</h1>
        ...
        <form action="{{ route('produk.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid gap-2 sm:grid-cols-2 sm:gap-2">
                ...
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <button id="dropdownCheckboxButton" data-dropdown-toggle="dropdownDefaultCheckbox" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Daftar Kategori <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
