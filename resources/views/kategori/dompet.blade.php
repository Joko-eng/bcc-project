...
<body class="bg-gray-100">
  ...
  <a href="/kategori/ikat-pingang" class="flex items-center rounded-lg border border-gray-200 bg-white px-5 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
