...
@section('content')
    <section class="container mx-auto px-10 py-0">
        <div class="flex justify-center py-5">
            <div
                class="bg-white text-left p-5 rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 max-w-3xl">
                <!-- Breadcrumb -->
                ...
                <!-- Title -->
                <h3 class="text-3xl font-extrabold text-gray-900 mb-3">{{ $artikel->judul }}</h3>
                ...
                <div
                    class="card bg-white border-4 overflow-hidden rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300">
                    <img src="{{ asset('upload/artikel/' . $artikel->gambar) }}" class="img-fluid rounded-4">
                </div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <span class="self-center text-sm text-gray-700">By - {{ $artikel->nama_published }}</span>
                </div>
            </div>
        </div>
    </section>
